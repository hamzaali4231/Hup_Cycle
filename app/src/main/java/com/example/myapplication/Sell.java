...
public class Sell extends AppCompatActivity {
    ...
    private void validateProductData() {
        ...
        if(ImageUri==null){
            Toast.makeText(Sell.this,"Please select an image", Toast.LENGTH_SHORT);
        } else if(TextUtils.isEmpty(description)) {
            Toast.makeText(Sell.this,"Please input a description", Toast.LENGTH_SHORT);
        } else if(inputProductPrice.getText().toString().isEmpty()) {
            Toast.makeText(Sell.this, "Please input a price", Toast.LENGTH_SHORT);
...
//            Toast.makeText(AdminAddNewItem.this,"Please input a price", Toast.LENGTH_SHORT);
            ...
            Toast.makeText(Sell.this,"Please input a product name", Toast.LENGTH_SHORT);
        } else{
    ...
    private void StoreProductInformation() {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(Sell.this,"Wrong: "+ message, Toast.LENGTH_SHORT);
                loadingbar.dismiss();
            }
        }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(Sell.this,"Image uploaded successfully ", Toast.LENGTH_SHORT);
                ...
                Task<Uri> uriTask= uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(Sell.this, "loading Image Saved to the database....", Toast.LENGTH_SHORT).show();
